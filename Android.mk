...
ifeq ($(BOARD_INCLUDE_DTB_IN_BOOTIMG),true)
  ...
  HYBRIS_BOOTIMAGE_ARGS += --dtb $(INSTALLED_DTBIMAGE_TARGET)
  BOOTIMAGE_EXTRA_DEPS += $(INSTALLED_DTBIMAGE_TARGET)
endif
...
$(LOCAL_BUILT_MODULE): $(INSTALLED_KERNEL_TARGET) $(RECOVERY_RAMDISK) $(MKBOOTIMG) $(BOOTIMAGE_EXTRA_DEPS)
	...
	@mkdir -p $(dir $@)
	@rm -rf $@
	$(hide)$(MKBOOTIMG) --ramdisk $(RECOVERY_RAMDISK) $(HYBRIS_RECOVERYIMAGE_ARGS) $(BOARD_MKBOOTIMG_ARGS) $(INTERNAL_MKBOOTIMG_VERSION_ARGS) --output $@
